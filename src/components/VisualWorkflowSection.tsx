...
const VisualWorkflowSection: React.FC<VisualWorkflowSectionProps> = ({ connectionStatus }) => {
  ...
  const baseUrl = window.location.hostname === 'localhost' ? 'http://localhost:5000' : 'https://192.168.29.20:8000';
  const wsUrl = window.location.hostname === 'localhost' ? 'ws://localhost:5000' : 'wss://192.168.29.20:8000';
